        ...
        <div className='my-1'>
          <div className="pt-8 w-full container mx-auto flex justify-center items-center flex-col mb-8">
            ...
            <div className='courses-grid w-full grid grid-cols-3 justify-items-center items-center mt-8 gap-12 mb-12'>
              {
                work?.map((item) => (
                  <div key={item.ProjectTitle} className='dark:bg-slate-800 dark:shadow-black dark:shadow-sm w-96 bg-white shadow-lg shadow-gray-300 rounded-2xl text-md h-96' style={{ height: "100%" }}>
