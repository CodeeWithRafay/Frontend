...
`}</style>
      <div className='container mx-auto w-full md:mt-24 md:px-32 min-h-screen'>
        <div className='card w-full flex flex-col justify-center items-center py-8  rounded-2xl shadow-lg'>
          ...
          <Image className='rounded-full mt-10 border-black border-2 ' width={130} height={50} src={logo} alt='img' priority={true}></Image>
          <div className='card flex gap-14 mt-10 mb-5  dark:bg-gray-600 rounded-xl bg-gray-300 p-5' >
            <Link href="https://www.linkedin.com/in/abdul-rafay-97285b274/" target="_blank">
              <svg
            ...
            <Link href="https://www.facebook.com/codeewithrafay/" target="_blank"><svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-7 w-7 dark:text-white dark:hover:text-purple-600 hover:text-purple-600 transition-colors"
              fill="currentColor"
              viewBox="0 0 24 24">
            ...
            <Link href="https://www.instagram.com/officialcodewithrafay/" target="_blank"><svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-7 w-7 dark:text-white dark:hover:text-purple-600 hover:text-purple-600 transition-colors"
              fill="currentColor"
              viewBox="0 0 24 24">
            ...
            <Link href="https://twitter.com/codewithraafay" target="_blank"><svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-7 w-7 dark:text-white dark:hover:text-purple-600 hover:text-purple-600 transition-colors"
              fill="currentColor"
              viewBox="0 0 24 24">
