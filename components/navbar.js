  ...
  return (
    <>
      <div className="navbar real-navbar w-full z-50 sticky bg-white top-0 border-b border-grey-light shadow-md dark:bg-gray-800 dark:border-black">
              ...
              <div className="buttons md:ml-auto mb-3">
                {session ? (
                  <button
                    ...
                    className="inline-flex items-center bg-purple-700 dark:bg-purple-600 text-white border-0 py-2 px-3 focus:outline-none hover:bg-purple-800 rounded-lg text-sm mt-4 dark:hover:bg-purple-700"
                  >
                    Logout
                  </button>
                ) : (
                  <>
                    <Link href="/login">
                      <button className="inline-flex items-center bg-purple-700 dark:bg-purple-600 text-white border-0 py-2 px-3 focus:outline-none hover:bg-purple-800 dark:hover:bg-purple-700 rounded-lg text-sm mt-4 font-normal">
                        Login
                      </button>
                    </Link>
                    <Link href="/signup">
                      <button className="mx-2 inline-flex items-center bg-purple-700 dark:bg-purple-600 text-white border-0 py-2 px-3 focus:outline-none hover:bg-purple-800 rounded-lg dark:hover:bg-purple-700  text-sm mt-4 button-signup font-normal">
                        Signup
                      </button>
                    </Link>
                  </>
        ...
        <div
          className={`absolute z-50 block mt-1 w-full invisible md:ml-auto flex-col gap-5 py-5 font-bold text-purple-500 bg-purple-100 flex-wrap items-center text-xl justify-end text-pretty shadow-md shadow-gray-200 menu-nav ${
